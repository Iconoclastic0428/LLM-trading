# Momentum Select strategy

This directory packages the frozen Momentum Select model, its audited real-S&P-500 replay, annual performance renders, and weekly holding history.
...
| Metric | Momentum Select | QQQ | SPY |
|---|---:|---:|---:|
