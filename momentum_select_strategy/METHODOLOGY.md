...
The file in strategy/candidate_strategy.py is the frozen Momentum Select policy. Its hash is checked by scripts/verify_package.py. The strategy ranks intermediate momentum and realized volatility cross-sectionally, applies a positive-momentum gate, retains qualifying incumbents through rank 10, and fills up to five 20% positions every five sessions.
