...
def load_visible_long_frames(
    ...
    Every episode is an independent history ending immediately before its
    sealed continuation. Keeping episodes separate prevents rolling features
    from treating unrelated panels as adjacent sessions.
    """
